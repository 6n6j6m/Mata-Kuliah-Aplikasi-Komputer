...
\end{eulercomment}
\eulersubheading{Mengatur luas bidang koordinat}
\begin{eulerprompt}
>setPlotRange(-0.5,2.5,-0.5,2.5): // mendefinisikan bidang koordinat baru 
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-001.png}
\eulersubheading{Menggambar Titik dan Ruas Garis}
\begin{eulercomment}
Sekarang tetapkan tiga titik dan plot mereka. Kita ambil 3 titik
A,B,C, misalkan titik A pada koordinat (1,0)
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulercomment}
Kemudian kita akan menghubungkan titik A dan B menjadi sebuah garis
yang diberi nama "c"
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulercomment}
\eulersubheading{Menggambar Garis yang Melalui 2 Titik}
\begin{eulerprompt}
...
\end{eulercomment}
\eulersubheading{Menggambar Titik Potong}
\begin{eulerprompt}
>D=lineIntersection(h,lineThrough(B,C)): // D adalah titik potong h dan BC
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-008.png}
\begin{eulercomment}
Setelah itu kita akan mencari koodinat titik D.
\end{eulercomment}
\begin{eulerprompt}
...
\eulersubheading{Menghitung luas dari segitiga ABC:}
\begin{eulercomment}
\end{eulercomment}
\begin{eulerformula}
\[
...
\end{euleroutput}
\begin{eulercomment}
norm(A-D):mencari panjang ruas garis AD

Atau kita dapat mencari luas segitiga tersebut dengan fungsi berikut
\end{eulercomment}
\begin{eulerprompt}
...
\begin{euleroutput}
  1.5
\end{euleroutput}
\eulersubheading{Menentukan Besar Sudut}
\begin{eulercomment}
Jika akan mencari sudut C dalam satuan derajat
\end{eulercomment}
\begin{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Besar sudut C adalah 36° 52 menit dan 11.63 detik

\end{eulercomment}
\eulersubheading{Menggambar Lingkaran Luar Segitiga}
\begin{eulerprompt}
>z=circleThrough(A,B,C); // lingkaran luar segitiga ABC
>R=getCircleRadius(z); // jari2 lingkaran luar 
>O=getCircleCenter(z); // titik pusat lingkaran c 
>plotPoint(O,"O"); // gambar titik "O"
>plotCircle(z,"Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-012.png}
\begin{eulercomment}
Dari gambar plot tersebut kita dapat menghitung koordinat tiitk pusat
...
\begin{euleroutput}
  ...
  1.17851130198
\end{euleroutput}
\eulersubheading{Menggambar Lingkaran Dalam Segitiga}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Setelah didapat koordinat P, tammbahkan semuanya ke plot.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulercomment}
Segitiga tersebut merupakakn segitiga sama kaki\\
...
>O=getCircleCenter(c);
>plotPoint(O,"O");
>plotCircle(c,"Lingkaran luas segitiga ABC"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-018.png}
\begin{eulerprompt}
>LL := pi*(R^2) // luas lingkaran luar
\end{eulerprompt}
\begin{euleroutput}
  39.2699081699
\end{euleroutput}
\begin{eulerprompt}
>LD := pi*(r^2) // luas lingkaran dalam
\end{eulerprompt}
\begin{euleroutput}
  7.34417132895
\end{euleroutput}
\eulersubheading{Contoh 2: Persamaan Garis dan Koordinat Titik dengan Geometri}
\begin{eulercomment}
Simbolik
...
simbol-simbol matematis dan aljabar utnuk merepresentasikan dan
memanippulasi objek-objek geomteri,seperti titik, garis, bidang, dan
bangun tiga dimensi.

File geometri menyediakan fungsi yang sama (dan lebih banyak lagi)
dari Maxima. Namun, kita dapat menggunakan perhitungan simbolik
sekarang.

\end{eulercomment}
\eulersubheading{Menentukan persamaan garis melalui 2 titik}
\begin{eulerprompt}
>A &= [1,0]; B &= [0,1]; C &= [2,2]; // menentukan tiga titik A, B, C
\end{eulerprompt}
\begin{eulercomment}
Fungsi untuk garis dan lingkaran bekerja seperti fungsi Euler, tetapi
memberikan perjitungan simbolis.
\end{eulercomment}
\begin{eulerprompt}
...
\end{euleroutput}
\eulersubheading{Mencari persamaan garis menggunakan metode simbolik}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-020-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-022-large.png}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Selanjutnya kita mencari garis yang tegak lurus dengan BC, dan melalui
titik A
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulercomment}
\eulersubheading{Mencari Titik Potong Garis h dengan Garis BC}
\begin{eulerprompt}
...
garis dari titik A menuju titik D, dan menghasilkan koordinat yang
sama
\end{eulercomment}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulersubheading{Mencari Panjang garis AD}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulersubheading{Menentukan Titik Pusat dan Jari-jari}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Menampilkan nilai jari-jari dalam bentuk desimal
\end{eulercomment}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-029-large.png}
\eulersubheading{Mencari Nilai Sudut dari ABD}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulersubheading{Mencari Persamaan Garis Bagi dan Titik Potong Sudut ABC}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Mencari titik potong 2 garis bagi tersebut
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulercomment}
Tentu saja kita dapat memotong garis dengan lingkaran dan lingkaran
dengan lingkaran.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulercomment}
\eulersubheading{Mencari Titik Koordinat P1 dan P2 dalam (x,y)}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Menyederhanakan hasil solusi menggunakan radcan, terutama jika hasil
...
\end{eulerprompt}
\eulersubheading{Mencari Titik Potong Antara Dua Lingkaran}
\begin{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Selanjutnya akan dilakukan hal yang sama di Maxima dengan koordinat
secara umum

Membuat lingkaran dan mencar titik potong
\end{eulercomment}
\begin{eulerprompt}
>A &= [a1,a2]; B &= [b1,b2];
>c1 &= circleWithCenter(A,distance(A,B));
...
\end{eulerprompt}
\begin{eulercomment}
Persamaan dapat disederhanakan dengan memecah y.
...
\end{eulerformula}
\begin{eulercomment}
Persamaan ini biasanya berbentuk linier, y=mx+by, dengan m sebagai
gradien
...
\end{eulerformula}
\begin{eulercomment}
Selanjutnya kita akan menentukan persamaan garis yang melalui tiitk A
dan B
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
m_{1}.m_{2}=\frac{-(b_1-a_1)}{(b_2-a_2)}\times \frac{(b_2-a_2)}{(b_1-a_1)} = -1.
\]
\end{eulerformula}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Nilai y didapat dengan langkah-langkah berikut\\
\end{eulercomment}
\begin{eulerformula}
\[
AC=\sqrt{(x-0)^{2}+(y-0)^{2}}
...
y=\frac{\sqrt{\left(-c+b+a\right)\,\left(c-b+a\right)\,\left(c+b-a
 \right)\,\left(c+b+a\right)}}{2\,\left| a\right| }
\]
\end{eulerformula}
\begin{eulercomment}
Setelah mendapat solusi, ekstrak solusi y Kita telah mendapatkan nilai
y, selanjutnya kita akan memasukkan nilai y ke dalam rumus luas
segitiga
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Terbukti bahwa rumus heron merupakan rumus luas segitiga jika
...
\end{euleroutput}
\begin{eulercomment}
Dan juga terlihat jelas bahwa ini adalah segitiga dengan luas maksimal
dan dua sisi 3 dan 4.
\end{eulercomment}
\begin{eulerprompt}
>aspect (1.5); plot2d(&H(3,4,x),1,7): // Kurva luas segitiga sengan panjang sisi 3, 4, x (1<= x <=7)
\end{eulerprompt}
\eulerimg{17}{images/EMT4Geometry-056.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Sekarang mari kita cari himpunan semua titik dimana b+c=d untuk semua
konstan d. Hal ini dikenal dengan elips.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
kita dapat menggambar himpunannya. Sisi b bervariasi dari 1 hingga 4.
Terlihat jelas bahwa kita mendapatkan elips.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulercomment}
Kita dapat memeriksa persamaan umum untuk elips, yaitu:
...
\end{eulerformula}
\begin{eulercomment}
dimana (xm,ym) adalah pusat, dan u serta v adalah setelah sumbu.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{euleroutput}
  ...
  Error in:
  ratsimp((fx(a,c,d)-a/2)^2/u^2+fy(a,c,d)^2/v^2 with [u=d/2,v=sq ...
               ^
\end{euleroutput}
\begin{eulercomment}
Kita lihat bahwa tinggi dan luas maksimal untuk x=0. Jadi, luas
segitiga dengan a+b+c=d maksimal jika segitiga sama sisi. Kami ingin
menurunkan ini secara analitik.
\end{eulercomment}
\begin{eulerprompt}
...
satu sisi 0 dan solusinya adalah a=b=c=d/3.
\end{eulercomment}
\begin{eulerprompt}
>$solve(eqns,[a,b])
\end{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Ada juga meotde Lagrange, memaksimalkan\\
\end{eulercomment}
\begin{eulerformula}
\[
H(a,b,c)^{2}
...
\end{euleroutput}
\begin{eulercomment}
Kita dapat memplot situasinya
\end{eulercomment}
\begin{eulercomment}
Pertama-tama atur titik dengan Maxima
\end{eulercomment}
\begin{eulerprompt}
>A &= at([x,y],sol[2]); $A
\end{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Lalu atur rentang plot, dan plot titik-titiknya
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulercomment}
Cari garis tegak lurusnya dengan Maxima
\end{eulercomment}
\begin{eulerprompt}
>h &= middlePerpendicular(A,B); g &= middlePerpendicular(B,C);
\end{eulerprompt}
\begin{eulercomment}
Dan juga cari pusat lingkarannya.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-070.png}
\begin{eulercomment}
Menggunakan geometri, kita mendapatkan rumus yang sederhana
...
\end{eulerformula}
\begin{eulercomment}
untuk radiusnya. Kita dapat memeriksa apakah ini benar, dengan
memanfaatkan Maxima. Maxima akan memfaktorkan ini hanya jika kita
kuadratkan.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulercomment}
Garis Euler adalah garis yang ditentukan dari sebarang segitiga yang
...
-Orthocenter: titik potong garis tinggi\\
...
\end{eulerprompt}
\begin{eulercomment}
Untuk memplot objek geometri, kita menyiapkan area plot, dan menambah
titik-titiknya. Semua plot objek geometri ditambahkan ke plot saat
ini.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\begin{eulercomment}
Kita jufa dapat menambahkan sisi-sisi segitiga
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulercomment}
Berikut adalah luas segitiga, dengan menggunakan formula determinan.
Tentu saja kita harus mengambil nilai absolute dari hasilnya.
\end{eulercomment}
\begin{eulerprompt}
>$areaTriangle(A,B,C)
\end{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Sekarang kita akan menghitung keliling ABC
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Plot lingkaran dan pusatnya. Cu dan U adalah simbolik. Kita akan
mengevaluasi ekspresi ini untuk Euler
\end{eulercomment}
\begin{eulerprompt}
>plotCircle(LL()); plotPoint(O(),"O"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-080.png}
\begin{eulercomment}
Kita dapat menghitung perpotongan ketinnggian di ABC (pusat
orhtocenter) secara numerik dengan perintah berikut
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Tambahkan hal tersebut ke dalam plot kita
\end{eulercomment}
\begin{eulerprompt}
>plotPoint(H(),"H"); plotLine(el(),"Garis Euler"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-083.png}
\begin{eulercomment}
...
\begin{eulercomment}
Teori mengatakan bahwa MH=2*MO. Kita perlu menyederhanakan radcan
...
\end{eulerformula}
\begin{eulercomment}
Fungsi ini juga mencakup fungsi untuk sudut
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\begin{eulercomment}
Lalu tambahkan ini ke dalam plot
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-092.png}
\begin{eulercomment}
Seharusnya ini menjadi beberapa fungsi, tetapi solver default dari
Maxima dapat mencari solusi ini hanya jika kita mengkuadratkan
persamaannya. Akibatnya, kita mendapatkan hasil yang palsu atau bukan
sebenarnya.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
y=-3x-\sqrt{70}\sqrt{9-20x}+26
\]
\end{eulerformula}
\begin{eulercomment}
Tambahkan solusi pertama ke plot, itu merupakan jalan yang kita cari.
Teori mengatakan bahwa hal tersebut merupakakn parabola yang diputar.
\end{eulercomment}
\begin{eulerprompt}
>plot2d(&rhs(akar[1]),add=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-094.png}
\begin{eulerprompt}
...
\begin{eulercomment}
Ini terinspirasi dari ceramah N.J.Wildberger. Dalam buku "Devine
PProportions", Wildberger bertujuan untuk menggantikan pengertian
klasik dari jarak dan sudut dengan kuadran dan penyebaran. Menggunakan
ini, memang mungkin untuk menghindari fungsi trigonometri dalam banyak
contoh, dan untuk tetap "rasional".

Dalam contoh berikut, Saya akan memperkenalkan konsep dan memecahkan
beberapa masalah. Saya menggunakan komputasi simbolik Maxima disini,
yang mana akan menyembunyikan keuntungan utama dati trigonomteri
rasional bahwa komputasi dapat dilakukan hanya dengan pensil dan
kertas. Kalian dipersilahkan utntuk mengecek hasilnya tanpa bantuan
komputer.

Intinya adalah komputasi simbolik rasional biasanya menghasilkan hasil
yang sederhana. Sebaliknya, trigonometri klasikal biasanya
...
dengan porporsi Mesir yang terkenal yaitu 3,4, dan 5. Perintah berikut
adalah perintah Euler untuk memplot bidang geometri yang berada di
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-101.png}
\begin{eulercomment}
Tentu saja,
...
\end{eulerformula}
\begin{eulercomment}
adalah tempat dimana wa adalah sudut di A. Cara yang biasa digunakan
untuk menghitung sudut ini adalah dengan mengambil invers dari fungsi
sinus. Hasilnya adalah sudut yang tidak dapat dicerna, yang hanya
dapat digambarkan perkiraannya.
\end{eulercomment}
\begin{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Trigonomteri rasional mencoba untuk menghindari hal ini.

Definisi pertama dari trigonometri rasional adalah kuadran, yang
menggantikan jarak. Faktanya, hal itu hanyalah jarak yang
dikuadratkan. Berikut a, b, dan c menotasikan kuadran dari
sisi-sisinya.

Teorema Phytagoras menjadi a+b=c
\end{eulercomment}
\begin{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Definisi kedua dari trigonomtri rasional adalah penyebaran. Spread
mengukur pembukaan antar garis. Hal ini adalah 0 jika garisnya sejajar
...
\end{eulerformula}
\begin{eulercomment}
dimana a dan c adalah kuadrat dari sembarang persegi panjang dengan
salah satu sudut di A.
\end{eulercomment}
\begin{eulerprompt}
>sa &= a/c; $sa
\end{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Tentu saja hal ini lebih mudah untuk dihitung daripada sudut. Tapi
kaliam kehilangan properti bahwa sudut dapat ditambahkan dengan mudah.

Tentu saja kita dapat mengonversi pendekaran kita untuk sudut wa
...
\end{euleroutput}
\begin{eulercomment}
Hukum kosinus trigonometri klasik menerjemahkan ke dalam "hukum
silang" berikut.
...
\end{eulerformula}
\begin{eulercomment}
dengan a, b, dan c adalah kuadrat dari sisi-sisi segitiga, dan sa
adalah penyebaran sudut A. Sisi a seperti biasanya, merupakan sisi
yang bersebrangan dengan sudut A.

Hukum ini diimplementasikan dalam file geometry.e yang kita muat ke
Euler tadi.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Mari kita gunakan hukum silang untuk menemukan penyebaran ke A. Untuk
melakukan hal ini, kita buat hukum silang untuk kuadrat a, b, dan c
dan selesaikan dengan penyebaran sa yang tidak diketahui.

Kalian dapat melakukan ini secara manual dengan mudah, tetapi Saya
menggunakan Maxima. Tentu saja kita mendapatkan hasil yang telah kita
miliki.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Kita sudah tau ini. Definisi dari penyebaran adalah kasus spesial dari
hukum silang atau cross law.

Kita juga dapat memecahkan hal ini untuk semua a, b, dan c. Hasilnya
adalah formula yang menghitung penyebaran dari sudut segitiga yang
diberi kuadrat dari ketiga sisinya.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Kita dapat membuat fungsi dari hasilnya. Fungsi seperti itu sudah
...
\end{eulerformula}
\begin{eulercomment}
Sebagai contoh, kita menggunakannya untuk menhitung sudut dari
...
\end{eulerformula}
\begin{eulercomment}
Hasilnya rasional, yang mana tidak mudah untuk didapatkan jika kita
...
\end{eulerformula}
\begin{eulercomment}
Ini aadalah sudut dalam derajat.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulercomment}
Sekarang, mari kita mencoba lebih banyak contoh yang lebih kompleks.

Kita mendefinisikan tiga sudut segitiga sebagai berikut.
\end{eulercomment}
\begin{eulerprompt}
>A&:=[1,2]; B&:=[4,3]; C&:=[0,4]; ...
...
\begin{eulercomment}
Dengan menggunakan Phytagoras, kita dapat dengan mudah mencari jarak
dari dua titik. Saya pertama kali menggunakan fungsi jarak di Euler
file untuk geometri. Fungsi jarak menggunakan geometri klasik.
\end{eulercomment}
\begin{eulerprompt}
>$distance(A,B)
\end{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Euler juga memuat fungsi untuk kuadrat diantara dua titik.

Dalam contoh berikut, karena c+b bukan merupakan a, maka segitiganya
bukan merupakan persegi panjang.
\end{eulercomment}
\begin{eulerprompt}
...
\eulersubheading{Titik Ketiga (Titik Fermat)}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Kita memplot semuanya sejauh ini
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Dan cari pusat dari kedua lingkaran dimana jaraknya sebanding.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerprompt}
>load povray;
>defaultpovray="D:\(\backslash\)POVRay\(\backslash\)bin\(\backslash\)pvengine64.exe"
\end{eulerprompt}
\begin{euleroutput}
  D:\(\backslash\)POVRay\(\backslash\)bin\(\backslash\)pvengine64.exe
\end{euleroutput}
\begin{eulercomment}
Kami mengatur adengan dengan tepat
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\begin{eulercomment}
Sekarang kita menghasilkan dua titik pada lingkaran, dimana bola
menyentuh kerucut
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\begin{eulercomment}
Kemudian kami menghasilkan dua titik dimana bola menyentuh bidang. Ini
adalah fookus dari elips.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\begin{eulercomment}
Sekarang kita menghasilkan pira abu-abu dimana bola menyentuh kerucut
\end{eulercomment}
\begin{eulerprompt}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMT4Geometry-185.png}
\begin{eulercomment}
...
lebih baik dengan kacamata merah/cyan.
\end{eulercomment}
\begin{eulerprompt}
...
>O=getCircleCenter(c);
>plotPoint(O,"O");
>plotCircle(c,"Lingkaran Persegi ABCD"):
\end{eulerprompt}
...
\begin{eulerprompt}
>l=angleBisector(P,Q,R);
>m=angleBisector(Q,R,S);
>T=lineIntersection(l,m);
...
\end{eulercomment}
\begin{eulerprompt}
>r=norm(T-projectToLine(T,lineThrough(P,Q)));
>plotCircle(circleWithCenter(T,r),"Lingkaran dalam segiempat PQRS"):
\end{eulerprompt}
...
\end{eulercomment}
\begin{eulerprompt}
>PQ=norm(P-Q) //panjang sisi AB
\end{eulerprompt}
\begin{euleroutput}
  8
\end{euleroutput}
\begin{eulerprompt}
>RS=norm(R-S) //panjang sisi CD
\end{eulerprompt}
\begin{euleroutput}
  8
\end{euleroutput}
\begin{eulerprompt}
>PS=norm(P-S) //panjang sisi AD
\end{eulerprompt}
\begin{euleroutput}
  8
\end{euleroutput}
\begin{eulerprompt}
>QR=norm(Q-R) //panjang sisi BC
\end{eulerprompt}
\begin{euleroutput}
  8
\end{euleroutput}
...
>fcontour("d2",xmin=-4,xmax=4,ymin=-4,ymax=2,hue=1):
\end{eulerprompt}
